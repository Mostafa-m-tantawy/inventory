                        ...
                        <div class="kt-form kt-form--label-right">
                            <div class="kt-portlet__body">
                                <div class="form-group form-group-xs row">
                                    ...
                                    <div class="col-7">
                                        <span
                                            class="form-control-plaintext kt-font-bolder">{{$center->name}}</span>
                                    </div>
                                </div>
                                <div class="form-group form-group-xs row">
                                    ...
                                    <div class="col-7">
                                        <span
                                            class="form-control-plaintext kt-font-bolder">{{$center->description}}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="tab-content kt-margin-t-20">
                                ...
                                <div class="tab-pane active" id="kt_apps_contacts_view_tab_3" role="tabpanel">
                                    <form class="kt-form kt-form--label-right" method="post"
                                          action="{{route('center.update',$center->id)}}">
                                        @csrf
                                        {{ method_field('PUT') }}
                                        <div class="kt-portlet__body">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <h3>{{trans('main.center')}} {{trans('main.information')}}</h3>
                                                    <div class="form-group row">
                                                        <div class="col-12">
                                                            <label>{{trans('main.name')}}:</label>
                                                            <input type="text" required name="name" class="form-control"
                                                                   placeholder="Enter full name" value="{{$center->name}}">
                                                            <span class="form-text text-muted"> {{trans('main.center')}} {{trans('main.name')}}</span>
                                                        </div>
                                                        <div class="col-12">
                                                            <label class="">{{trans('main.description')}}:</label>
                                                            <input type="text" required name="description"
                                                                   value="{{$center->description}}" class="form-control" placeholder="Enter email">
                                                            <span
                                ...
                                <div class="tab-pane " id="stock_tab" role="tabpanel">
                                       <div class="kt-portlet__body">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <table class="datatable-responsive display table table-striped table-bordered " cellspacing="0">         <thead class="thead-dark">
                                                        <tr>
