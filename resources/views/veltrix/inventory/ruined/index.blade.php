...
@section('breadcrumb')
    <div class="col-sm-6">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="javascript:void(0);">{{trans('main.ruined product')}}</a></li>
        </ol>
    </div>
    <div class="col-sm-6">
        <div class="float-right d-none d-md-block">
            <a href="{{route('ruined.create')}}"
...
@section('scripts')
    ...
    <script>
        ...
        var accountTable = $('#datatable-responsive').DataTable({
            ...DatatableOptions,
            ajax: '{{ route('ruined.datatable-data')}}',
            columns: [
                {data: 'ruinedable', name: 'ruinedable', searchable: false, orderable: false},
